...
class StudiesControllerTest < ActionController::TestCase
  ...
  test 'should not create a study and reload the form for incomplete details' do
    ...
    assert_select 'div#role-0' do
      assert_select 'input#study_custom_metadata_attributes_data_role_affiliation_identifiers_0_data_identifier[value=?]', '01f7bcy98'
    ...
    assert_select 'div#role-1' do
      assert_select 'input#study_custom_metadata_attributes_data_role_affiliation_identifiers_1_data_identifier[value=?]', 'grid.424699.4'
      assert_select 'input#study_custom_metadata_attributes_data_role_affiliation_identifiers_1_data_scheme[value=?]', 'GRID'
    end
            ...
            data: {
              ...
              "role_affiliation_identifiers":{
                ...
                "1":{
                  "custom_metadata_type_id": linked_cmt.id,
                  "custom_metadata_attribute_id":linked_cma.id,
                  "data":{"identifier":"grid.424699.4", "scheme":""}
                }
              }
            }
          }
    ...
    assert_select 'div#error_explanation' do
      ...
      assert_select 'ul > li', text: "Custom metadata linked custom metadatas scheme is required"
    end
    ...
    assert_select 'div#role-1' do
      assert_select 'input#study_custom_metadata_attributes_data_role_affiliation_identifiers_1_data_identifier[value=?]', 'grid.424699.4'
      assert_select 'input#study_custom_metadata_attributes_data_role_affiliation_identifiers_1_data_scheme[value=?]', ''
    end
  ...
  test 'should not update a study and reload the form for incomplete details' do
    ...
    assert_select 'div#role-0' do
      assert_select 'input#study_custom_metadata_attributes_data_role_affiliation_identifiers_0_data_identifier[value=?]', '027m9bs27'
      assert_select 'input#study_custom_metadata_attributes_data_role_affiliation_identifiers_0_data_scheme[value=?]', 'ROR'
    end
